...
public class Rate50Test {
  ...
  @Test
  public void shouldThrowExceptionWhenInstrumented_throwPercentageIsRoughlyHalf()
      throws IOException {
    installAgent(
        "mode:fault,rate:0.5,filter:uk/co/probablyfine/bytemonkey/testfiles/FaultTestObject");
