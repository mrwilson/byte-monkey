...
public enum OperationMode {
  SCIRCUIT {
    public InsnList generateByteCode(
        TryCatchBlockNode tryCatchBlock, int tcIndex, AgentArguments arguments) {
  ...
  LATENCY {
    ...
    public InsnList generateByteCode(MethodNode method, AgentArguments arguments) {
      ...
      list.add(
          new MethodInsnNode(Opcodes.INVOKESTATIC, "java/lang/Thread", "sleep", "(J)V", false));
  ...
  NULLIFY {
    ...
    public InsnList generateByteCode(MethodNode method, AgentArguments arguments) {
      ...
      final OptionalInt firstNonPrimitiveArgument =
          IntStream.range(0, argumentTypes.length)
  ...
  public abstract InsnList generateByteCode(
      TryCatchBlockNode tryCatchBlock, int tcIndex, AgentArguments arguments);
}
